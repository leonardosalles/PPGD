define(['directives/directives'], function (directives) {
	...
	directives.directive('spaInputTime', function ($filter) {
		...
		return {
			...
			link: function (scope, element, attr, ctrl) {
				...
				element.parent().datetimepicker({format: I18n.lookup('spa.date').formats.mediumTime.replace('HH', 'hh'), pickDate: false});
				...
				ctrl.$parsers.unshift(function (value) {
					if (!value) {
						element.removeAttr('data-spa-validate-time');
						...
						if (angular.isDate(date)) {
							...
							element.attr('data-spa-validate-time', scope.$eval(attr.spaInputTimeMessage) || I18n.t('spa.validation.type.date', {pattern: I18n.lookup('spa.date').formats.mediumTime}));
