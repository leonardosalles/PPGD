define(['directives/directives'], function (directives) {
	...
	directives.directive('jetInputCpf', function () {
		...
		return {
			...
			link: function (scope, element, attr, ctrl) {
				var opts = angular.extend({mask: '999.999.999-99', autoTab: false}, scope.$eval(attr.jetInputCpf));
				...
				ctrl.$formatters.push(function (value) {
					...
					if (validated) {
						element.removeAttr('data-jet-validate-cpf');
					} else {
						element.attr('data-jet-validate-cpf', scope.$eval(attr.jetInputCpfMessage) || I18n.t('spa.validation.type.cpf'));
					}
