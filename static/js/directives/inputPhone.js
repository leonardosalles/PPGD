define(['directives/directives'], function (directives) {
	...
	directives.directive('jetInputPhone', function () {
		...
		return {
			...
			link: function (scope, element, attr, ctrl) {
				var opts = angular.extend({flag: true}, scope.$eval(attr.jetInputPhone));
				...
				ctrl.$formatters.push(function (value) {
					if (!value) {
						element.removeAttr('data-jet-validate-phone');
					...
					if (region) {
						...
						element.attr('data-jet-validate-phone', scope.$eval(attr.jetInputPhoneMessage) || I18n.t('spa.validation.type.phone'));
